export pretrain_model_path=../EDPose_pretrained/models/
 ...
 --options batch_size=4 epochs=60 lr_drop=55 num_body_points=17 backbone='swin_L_384_22k' return_interm_indices=0,1,2,3 num_feature_levels=5 \
 --dataset_file="sign" \
 ...
 --test \
 --kp_output_dir /D_data/SL/sign_data_processing/msasl_demo/keypoints_edpose_coco_swinl_5scale \
